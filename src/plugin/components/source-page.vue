  ...
  renderButtons() {
    ...
    return (
      <div class="source-page-btn-group">
        ...
        {this.showExportButton && <el-button disabled={this.exporting} onClick={this.export} loading={this.exporting} type="primary">Export Data</el-button>}
    ...
    return (
      <div class="source-page">
        ...
        <div class="page-bottom">
          ...
          <el-button type="primary" icon="el-icon-setting" onClick={this.handleTableSetting}>Table Config</el-button>
        </div>
      </div>
    )
  }
